    ...
    <section className="section-product" id="product">
        ...
        <div className="container">
            ...
            <div className="product-header">
                ...
                <h2>What Is the <img src="https://wsrv.nl/?url=https://res.cloudinary.com/dvikl5pda/image/upload/v1777923479/Pink-White-Modern-Artificial-Intelligence-Logo-1_1_k2nhbu.webp&w=392&output=webp&q=85" alt="SaleRev-Ai" className="product-logo-inline" width="196" height="56" loading="lazy" decoding="async" /> ?</h2>
